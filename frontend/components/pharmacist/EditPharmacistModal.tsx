...
const EditPharmacistModal = ({ open, pharmacist, onSave, onClose }: any) => {
  const [form, setForm] = useState<any>(null);

  useEffect(() => {
    if (pharmacist) setForm(pharmacist);
  }, [pharmacist]);
  ...
  return (
    <Modal open={open} onClose={onClose} title="Edit Pharmacist" size="lg">
...
export default EditPharmacistModal;
